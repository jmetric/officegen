...
module.exports = {
  ...
  _getCell: function (val, options,idx,row_idx) {
    if((typeof val === 'object')){
      ...
      if(val.val){
        console.log('_getCell ' + JSON.stringify(val.val) + ' ' + JSON.stringify(val.val));
        val = val.val;
        console.log('_getCell ' + val);
      }
      if(val.options){
        console.log('_getCell ' + JSON.stringify(options) + ' ' + JSON.stringify(val.options));
        options = val.options;
        console.log('_getCell ' + JSON.stringify(options));
      }
      console.log('_getCell ' + val + ' ' + JSON.stringify(options));
    }
